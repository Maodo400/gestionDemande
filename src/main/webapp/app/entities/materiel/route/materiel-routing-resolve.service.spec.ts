...
describe('Service Tests', () => {
  describe('Materiel routing resolve service', () => {
    ...
    let routingResolveService: MaterielRoutingResolveService;
    let service: MaterielService;
    let resultMateriel: IMateriel | undefined;
    ...
    beforeEach(() => {
      ...
      routingResolveService = TestBed.inject(MaterielRoutingResolveService);
    ...
    describe('resolve', () => {
      ...
      it('should return new IMateriel if id is not provided', () => {
        // GIVEN
        ...
        expect(resultMateriel).toEqual(new Materiel());
      });
