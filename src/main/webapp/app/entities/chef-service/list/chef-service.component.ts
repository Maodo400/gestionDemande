...
export class ChefServiceComponent implements OnInit {
  ...
  trackId(index: number, item: IChefService): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IChefService[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
