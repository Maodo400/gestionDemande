...
class AgentResourceIT {
    ...
    void createAgent() throws Exception {
        ...
        assertThat(testAgent.getTel()).isEqualTo(DEFAULT_TEL);
        assertThat(testAgent.getFonction()).isEqualTo(DEFAULT_FONCTION);
    }
    ...
    void putNewAgent() throws Exception {
        ...
        assertThat(testAgent.getTel()).isEqualTo(UPDATED_TEL);
        assertThat(testAgent.getFonction()).isEqualTo(UPDATED_FONCTION);
    }
    ...
    void partialUpdateAgentWithPatch() throws Exception {
        ...
        partialUpdatedAgent.firstName(UPDATED_FIRST_NAME).email(UPDATED_EMAIL).tel(UPDATED_TEL);
