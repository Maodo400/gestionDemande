...
import sn.esp.gestion.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getFonction()).isEqualTo(DEFAULT_FONCTION);
    }
    ...
    void putNewClient() throws Exception {
        ...
        assertThat(testClient.getFonction()).isEqualTo(UPDATED_FONCTION);
    }
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.email(UPDATED_EMAIL).tel(UPDATED_TEL).fonction(UPDATED_FONCTION);
